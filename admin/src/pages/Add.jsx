    ...
    const onSubmitHandler = async(e) =>{
      ...
      try {
        ...
        const sortedSizes = [...sizes].sort((a, b) => {
          const indexA = sizeOrder.indexOf(a) === -1 ? 999 : sizeOrder.indexOf(a);
          const indexB = sizeOrder.indexOf(b) === -1 ? 999 : sizeOrder.indexOf(b);
    ...
    return (
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)}className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='20'/>
        </div>
